...
from apps.negocio.models import Carrito
from apps.negocio.ordenes.api.serializers import CarritoSerializer
from apps.negocio.ordenes.services.carrito_service import CarritoService
