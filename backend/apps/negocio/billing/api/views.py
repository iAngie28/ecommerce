...
from apps.negocio.models import Factura, TipoPago
from apps.negocio.billing.api.serializers import FacturaSerializer, TipoPagoSerializer
from apps.negocio.billing.services.factura_service import FacturaService, TipoPagoService
