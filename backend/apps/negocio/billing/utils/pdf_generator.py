...
def generar_pdf_factura(factura):
    ...
    if factura.cliente:
        p.drawString(120, height - 140, f"Nombre: {factura.cliente.nombre}")
        p.drawString(120, height - 150, f"Email: {factura.cliente.correo}")
    ...
    p.drawString(300, y - 30, f"TOTAL: Bs. {factura.monto_total:.2f}")
