...
from apps.negocio.models import Categoria
from apps.negocio.catalogo.api.categoria_serializer import CategoriaSerializer
from apps.negocio.catalogo.services.categoria_service import CategoriaService
